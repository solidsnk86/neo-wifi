          ...
          >
                    ...
                    <td valign="middle">
                      ...
                      >
                        <tr>
                          ...
                          <td style="padding-left: 10px" class="eyebrow mono">
                            neo-wifi &middot; feedback
                          </td>
                        </tr>
                      </table>
                    </td>
            ...
            <tr>
              <td style="padding: 20px 36px 0 36px">
                ...
                <div class="subhead" style="padding-top: 4px">
            ...
            <tr>
              <td style="padding: 22px 36px 0 36px">
                <div class="body-text">
                  Recibimos correctamente tu mensaje desde Neo WiFi. Quedó
                  registrado con estos datos:
                </div>
              </td>
            </tr>
                ...
                >
                  ...
                  <tr>
                    <td style="padding: 10px 16px 16px 16px">
                      <div class="terminal-line mono">&gt; version: ${version}</div>
                ...
                >
                  <tr>
                    ...
                    >
                      ...
                      <div class="feature-title" style="padding-top: 10px">
                        Monitoreo de antenas
                      </div>
                      <div class="feature-desc" style="padding-top: 4px">
                        Accedé a información detallada sobre cada antena del
                        sistema provincial.
                      </div>
                    </td>
                    <td
                    ...
                    >
                      ...
                      <div class="feature-desc" style="padding-top: 4px">
                        Administrá tu conexión desde tu PC de manera eficiente y
                        sin complicaciones.
                      </div>
                    </td>
                  </tr>
            ...
            <tr>
              <td style="padding: 22px 36px 0 36px">
                <div class="footer-text">
                  ¿Necesitás agregar algo más? Respondé directamente a este
                  correo.
                </div>
              </td>
            </tr>
                ...
                >
                  <tr>
                    <td style="padding-bottom: 10px">
                      <a
                        href="https://neo-wifi.vercel.app"
                        class="btn btn-solid"
                        >Volver a Neo WiFi</a
                      >
                    </td>
                  ...
                  <tr>
                    <td>
                      <a
                        href="https://neo-wifi.vercel.app/download"
            ...
            <tr>
              <td style="padding: 18px 36px 28px 36px">
                <div class="footer-text mono">
                  © 2025 neo-wifi &middot; san luis, argentina
                </div>
                <div style="padding-top: 8px">
                  ...
                  >&nbsp;&nbsp;
                  <a
                    href="https://gabrielcalcagni.vercel.app"
                    class="footer-link mono"
                    >sitio web</a
                  >&nbsp;&nbsp;
                  <a href="tel:5492665290020" class="footer-link mono">teléfono</a>
                </div>
              </td>
            </tr>
          </table>
