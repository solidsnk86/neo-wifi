...
export const Donation = ({ content }: { content: string }) => {
  return (
    <Link
      className={`w-fit border border-zinc-200/70 dark:border-zinc-800/50 p-3 my-16 rounded-[14px] flex justify-center mx-auto hover:scale-110 hover:dark:border-green-300/30 z-50 backdrop-blur-lg
    ...
    >
      <CoffeeIcon
        className="w-10 h-10 flex justify-center mx-auto py-1 px-2 border border-green-300/50 rounded-xl bg-green-200/30"
        fill="#16a34a"
      />
