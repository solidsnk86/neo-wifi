...
const accordionLists = [
  {
    ...
    answer:
      "Neo-Wifi es una aplicación para poder ver información precisa sobre las antenas del Gobierno de la provincia de San Luis. Permite a los usuarios localizar y obtener detalles técnicos de las antenas wifi públicas en toda la provincia.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer:
      "Para usar Neo-Wifi, simplemente descarga la aplicación desde la tienda de aplicaciones de tu dispositivo, crea una cuenta y comienza a explorar el mapa de antenas. La interfaz es intuitiva y fácil de usar.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      "No por ahora tiene cobertura en la zona norte de la provincia, Neo-Wifi no cubre toda la provincia de San Luis. El servicio está disponible en las siguientes zonas urbanas: Concarán, Santa Rosa, Tilisarao, Villa Larca, Los Molles, Carpintería, próximamente Merlo.",
  },
  {
    id: 6,
    question: "¿Necesito conexión a internet para usar la aplicación?",
    answer:
      "Se requiere conexión a internet para la primera carga y actualizaciones de datos. Sin embargo, puedes descargar mapas para uso offline en áreas específicas.",
  },
];
