...
export const Footer = () => {
  return (
    <footer className="text-zinc-900 dark:text-zinc-200 border dark:border-zinc-800/50 border-zinc-300/70 rounded-2xl pt-12 pb-8 relative z-20 backdrop-blur-2xl">
