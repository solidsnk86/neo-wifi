...
export const GeoPosition = ({
  ...
  return (
    <div className="border bg-[#FFFFFF] dark:bg-zinc-800/50 backdrop-blur-lg z-50 border-zinc-200/70 dark:border-zinc-800 p-3 rounded-2xl relative text-text-primary overflow-hidden">
      <h2
