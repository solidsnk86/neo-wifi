...
export const InfoWifi = ({ location, loading }: InfoWifiProps) => {
  return (
    <div className="border-2 bg-[#FFFFFF] dark:bg-zinc-800/50 border-zinc-200/70 dark:border-zinc-800 rounded-2xl relative text-text-primary overflow-hidden backdrop-blur-xl z-50">
