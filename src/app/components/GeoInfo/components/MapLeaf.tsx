...
const LeafMap = ({
  ...
  if (
    ...
    return (
      <div className="flex flex-col w-full h-80 justify-center items-center my-auto border-2 bg-[#FFFFFF] dark:bg-zinc-800/50 border-zinc-200/70 dark:border-zinc-800 rounded-2xl backdrop-blur-xl">
