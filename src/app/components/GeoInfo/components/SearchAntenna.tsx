...
export const SearchAntenna = ({
  ...
  return (
    <div className="border-2 mt-5 bg-[#FFFFFF] dark:bg-zinc-900/90 border-zinc-200/70 dark:border-zinc-800 rounded-2xl relative text-text-primary backdrop-blur-xl z-50">
