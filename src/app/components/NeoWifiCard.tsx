...
export default function NeoWifiAppCard() {
  ...
  return (
    <HomeBlock>
      <div className="flex flex-col md:flex-row items-center p-8 relative rounded-2xl border-2 border-zinc-200/70 dark:border-zinc-800 bg-white dark:bg-zinc-800/40 backdrop-blur-lg transition-all">
