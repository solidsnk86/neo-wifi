      ...
      <div className="border-2 border-zinc-200/70 dark:border-zinc-800 rounded-[16px] bg-[#FFFFFF] dark:bg-zinc-800/40 z-50 backdrop-blur-xl">
        <article className="border-b-4 border-zinc-300 dark:border-[#111111] rounded-[14px] p-3">
          <p className="relative flex text-center text-base md:text-lg text-zinc-900 dark:text-zinc-400 font-gloria-hallelujah">
            ...
            <QuoteIcon size={64} className=" text-zinc-400/70 dark:text-zinc-800 fill-yellow-300" />
          </p>
          <aside className="flex justify-center items-center gap-3 mt-4">
            <Image
              ...
              height={45}
              alt="Avatar Gabriel"
              className="rounded-full border-2 border-zinc-300 dark:border-zinc-500 outline-[1px] outline-offset-1 outline-double outline-yellow-300 select-none"
            />
            <div className="flex flex-col font-semibold text-zinc-600 font-gloria-hallelujah">
