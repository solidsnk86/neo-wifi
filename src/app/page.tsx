...
const HomeBlockTitle = ({ children }: { children: string }) => {
  return (
    <h1 className="md:text-[2.5rem] text-xl font-bold my-12 flex justify-center mx-auto bg-clip-text text-transparent bg-gradient-to-r from-[#b154ca] via-[#5281cf] to-[#6ddfff]">
      {children}
    </h1>
  );
};
