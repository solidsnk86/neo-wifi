    ...
    <>
      ...
      <section className="max-w-3xl flex justify-center mx-auto p-4">
        ...
        <article className="my-10">
          ...
          <p>
            El Sitio utiliza geolocalización para proporcionarte información
            sobre antenas gubernamentales cercanas, incluyendo su ubicación,
            distancia, SSID (identificador de red), dirección MAC y otros datos
            técnicos. Para ello, recopilamos y procesamos los siguientes tipos
            de información:
          </p>
          <ul className={styles.ul}>
            ...
            <li>
              <b>Datos de uso:</b> Recopilamos información sobre cómo
              interactúas con el Sitio, como las páginas visitadas, el tiempo de
              permanencia y las acciones realizadas.
            </li>
          </ul>
          ...
          <ul className={styles.ul}>
            <li>
              Proporcionarte información precisa y personalizada sobre las
              antenas gubernamentales cercanas.
            </li>
            <li>
          ...
          <h2 className={styles.h2}>
            3. Uso de Cookies (Información personal)
          </h2>
          <p>
          ...
          <p>
            ...
            seguro. No podemos garantizar la seguridad absoluta de la
            información.
          </p>
          ...
          <ul className={styles.ul}>
            ...
            <li>
              <b>Rectificación:</b> Solicitar la correción de información
            ...
            <li>
              <b>Limitación del Procesamiento:</b> Solicitar que limitemos el
              uso de tus datos
            </li>
            <li>
            ...
            <li>
              <b>Oposición:</b> Oponerte al procesamiento de tus datos en
          ...
          <p>
            ...
            momento. Te notificaremos de cambios significativos a través del
            Sitio o por otros medios. Te recomendamos revisar esta política
            periódicamente.
          </p>
