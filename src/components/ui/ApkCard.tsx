              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group-hover:flex hidden">
                {videoState ? (
                  <div
                    ...
                    className="p-2 rounded-full border bg-[#FFFFFF] dark:bg-zinc-800/40 border-zinc-200/70 dark:border-zinc-800 outline-none hover:outline-4 hover:outline-blue-500"
                  >
                    <Pause />
                  </div>
                ) : (
