    ...
    <div className="border-2 my-5 bg-[#FFFFFF] dark:bg-zinc-800/50 border-zinc-200/70 dark:border-zinc-800 rounded-2xl relative text-text-primary overflow-hidden backdrop-blur-xl z-50">
      <article className="border-b-4 border-zinc-300 dark:border-[#111111] rounded-xl p-3">
        ...
        <p className="my-6 text-pretty font-thin text-center">
          Descubrí la nueva aplicación oficial de Neo WiFi. Encontrá puntos de
          acceso gratuitos cerca de tu ubicación en tiempo real, consultá la
          distancia exacta a cada antena y conectate fácilmente a las redes
          públicas del gobierno.
        </p>
        {/* Marco Motorola */}
        {/* Marco externo */}
        <div className="relative flex justify-center mx-auto border-2 border-black w-fit rounded-3xl group">
          {/* Botones laterales */}
          ...
          <div className="relative border-[3px] border-[#6B6867] rounded-3xl">
            <div className="relative md:w-[400px] w-[310px] md:h-[800px] h-[660px] border-2 border-black rounded-[22px]">
              ...
              <video
                ...
                muted
              />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group-hover:flex hidden">
                {videoState ? (
                  <div
                    onClick={() => {
                      if (videoRef.current) {
                    ...
                    className="p-2 rounded-full border bg-[#FFFFFF] dark:bg-zinc-800/50 border-zinc-200/70 dark:border-zinc-800 outline-none hover:outline-4 hover:outline-blue-500"
                  >
                    <Pause />
                  </div>
                ) : (
        ...
        <div className="relative w-fit justify-center mx-auto group my-6">
          ...
          >
            ...
            <span className="-translate-x-[18px] group-hover:translate-x-0 transition-transform duration-500">
              Descargar APK
            </span>
          </a>
        </div>
